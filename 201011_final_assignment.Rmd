...
```{r put data descriptive indicators in table, echo=FALSE, message=FALSE, results='hide'}
...
```{r plot shares of employment,  echo=FALSE, message=FALSE, results='hide'}
...
education
```
```{r education shares table, echo=FALSE, message=FALSE, results='hide'}
...
```{r race shares table, echo=FALSE, message=FALSE, results='hide'}
...
```{r table the model, echo=FALSE, message=FALSE, results='hide'}
